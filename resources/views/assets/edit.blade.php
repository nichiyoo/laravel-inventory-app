        ...
        <div class="page-body">
            <div class="container-xl">
                <div class="row row-cards">
                    <div class="col-12">
                        <form action="{{ route('assets.update', $asset->id) }}" method="POST" class="card">
                            @csrf
                            @method('PUT')
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="name" name="name" type="text"
                                                    ...
                                                    autocomplete="off" value="{{ old('name') ?? $asset->name }}" required
                                                    autofocus aria-describedby="nameHelp" placeholder="Asset Name" />
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col">
                                                <textarea id="description" name="description" type="text"
                                                    ...
                                                    aria-describedby="descriptionHelp" placeholder="Asset Description" autofocus rows="5" required>{{ old('description') ?? $asset->description }}
                                                </textarea>
                                                <small class="form-hint">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="price" name="price" type="number"
                                                    ...
                                                    autocomplete="off" value="{{ old('price') ?? $asset->price }}" required
                                                    autofocus aria-describedby="priceHelp" placeholder="Asset Price" />
                                                <small class="form-hint">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="stock" name="stock" type="number"
                                                    ...
                                                    autocomplete="off" value="{{ old('stock') ?? $asset->stock }}" required
                                                    autofocus aria-describedby="stockHelp" placeholder="Asset Stock" />
                                                <small class="form-hint">
                                            ...
                                            <div class="col">
                                                <select id="category" name="category"
                                                    ...
                                                    <option value="Hardware"
                                                        {{ old('category') ?? $asset->category == 'Hardware' ? 'selected' : '' }}>
                                                        Hardware
                                                    </option>
                                                    <option value="Software"
                                                        {{ old('category') ?? $asset->category == 'Software' ? 'selected' : '' }}>
                                                        Software
                                                    </option>
                                                    <option value="Peripheral"
                                                        {{ old('category') ?? $asset->category == 'Peripheral' ? 'selected' : '' }}>
                                                        Peripheral</option>
                                                </select>
                                                <small class="form-hint">
